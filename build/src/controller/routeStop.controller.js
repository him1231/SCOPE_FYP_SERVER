...
exports.updateRouteStopsHandler = void 0;
...
function updateRouteStopsHandler(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var routes_1, stops_1, API_FARE_RULES_DATA, apiResult, dataMap_1, data, result, error_1;
            ...
            switch (_a.label) {
                ...
                case 3:
                    ...
                    apiResult.data
                        ...
                        var fareId = values[0].split('-');
                        var key1 = fareId[0] + "-" + fareId[1] + "-" + fareId[2];
                        dataMap_1[key1] = {
                            key: key1,
                            route: routes_1[values[1]],
                            bound: fareId[1],
                            seq: Number(fareId[2]),
                            stop: stops_1[values[2]],
                        };
                        var key2 = fareId[0] + "-" + fareId[1] + "-" + fareId[3];
                        dataMap_1[key2] = {
                            key: key2,
                            route: routes_1[values[1]],
                            bound: fareId[1],
                            seq: Number(fareId[3]),
                            stop: stops_1[values[3]],
                        };
                    });
                    data = Object.values(dataMap_1);
                    return [4 /*yield*/, (0, routeStop_service_1.createRouteStops)(data)];
                case 4:
                    result = _a.sent();
...
exports.updateRouteStopsHandler = updateRouteStopsHandler;
